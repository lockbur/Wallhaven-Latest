...
/**
 * INSERT into xx_tag(id,name,member_id,create_date,modify_date)
 * VALUES('kf8081814fe8474a014fe84789830000','test','1','2015-09-20
...
public interface TagDao {
    ...
    @Select("SELECT id FROM biz.xx_tag WHERE name = #{name}")
