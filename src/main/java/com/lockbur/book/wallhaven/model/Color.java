...
public class Color {
   ...
   {
      if(red >= 0 && red <= 255){
         throw new IllegalArgumentException(String.valueOf("red must be between 0 and 255"));
      }
      if(green >= 0 && green <= 255){
         throw new IllegalArgumentException(String.valueOf("green must be between 0 and 255"));
      }
      if(blue >= 0 && blue <= 255){
         throw new IllegalArgumentException(String.valueOf("blue must be between 0 and 255"));
      }
